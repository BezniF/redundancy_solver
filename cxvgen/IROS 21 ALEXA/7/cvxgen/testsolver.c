...
void load_default_data(void) {
  ...
  params.dotq_max[0] = 0.8307464872626844;
  params.a_max[0] = 0.9869848924080182;
  params.a_max[1] = 0.7643716874230573;
  params.a_max[2] = 0.7567216550196565;
  params.a_max[3] = -0.5055995034042868;
  params.a_max[4] = 0.6725392189410702;
  params.a_max[5] = -0.6406053441727284;
  params.dotq_prev[0] = 0.29117547947550015;
  params.dotq_prev[1] = -0.6967713677405021;
  params.dotq_prev[2] = -0.21941980294587182;
  params.dotq_prev[3] = -1.753884276680243;
  params.dotq_prev[4] = -1.0292983112626475;
  params.dotq_prev[5] = 1.8864104246942706;
}
