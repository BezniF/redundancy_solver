...
void load_default_data(void) {
  ...
  params.theta[0] = 0.8307464872626844;
  params.theta[1] = 0.9869848924080182;
  params.Q_lim[0] = 0.7643716874230573;
  params.Q_lim[1] = 0.7567216550196565;
  params.Q_lim[2] = -0.5055995034042868;
  params.Q_lim[3] = 0.6725392189410702;
  params.Q_lim[4] = -0.6406053441727284;
  params.Q_lim[5] = 0.29117547947550015;
  params.h_lim[0] = -0.6967713677405021;
  params.h_lim[1] = -0.21941980294587182;
  params.h_lim[2] = -1.753884276680243;
  params.h_lim[3] = -1.0292983112626475;
  params.h_lim[4] = 1.8864104246942706;
  params.h_lim[5] = -1.077663182579704;
  params.sigma_obs[0] = 0.7659100437893209;
  params.sigma_obs[1] = 0.6019074328549583;
  params.sigma_obs[2] = 0.8957565577499285;
  params.sigma_obs[3] = -0.09964555746227477;
  params.sigma_obs[4] = 0.38665509840745127;
  params.sigma_obs[5] = -1.7321223042686946;
  params.h_safe[0] = -1.7097514487110663;
  params.dotq_min[0] = -1.2040958948116867;
  params.dotq_min[1] = -1.3925560119658358;
  params.dotq_min[2] = -1.5995826216742213;
  params.dotq_min[3] = -1.4828245415645833;
  params.dotq_min[4] = 0.21311092723061398;
  params.dotq_min[5] = -1.248740700304487;
  params.dotq_max[0] = 1.808404972124833;
  params.dotq_max[1] = 0.7264471152297065;
  params.dotq_max[2] = 0.16407869343908477;
  params.dotq_max[3] = 0.8287224032315907;
  params.dotq_max[4] = -0.9444533161899464;
  params.dotq_max[5] = 1.7069027370149112;
  params.a_max[0] = 1.3567722311998827;
  params.a_max[1] = 0.9052779937121489;
  params.a_max[2] = -0.07904017565835986;
  params.a_max[3] = 1.3684127435065871;
  params.a_max[4] = 0.979009293697437;
  params.a_max[5] = 0.6413036255984501;
  params.dotq_prev[0] = 1.6559010680237511;
  params.dotq_prev[1] = 0.5346622551502991;
  params.dotq_prev[2] = -0.5362376605895625;
  params.dotq_prev[3] = 0.2113782926017822;
  params.dotq_prev[4] = -1.2144776931994525;
  params.dotq_prev[5] = -1.2317108144255875;
}
