...
void load_default_data(void) {
  ...
  params.dotq_min[0] = 1.3567722311998827;
  params.dotq_max[0] = 0.9052779937121489;
  params.a_max[0] = -0.07904017565835986;
  params.a_max[1] = 1.3684127435065871;
  params.a_max[2] = 0.979009293697437;
  params.a_max[3] = 0.6413036255984501;
  params.a_max[4] = 1.6559010680237511;
  params.a_max[5] = 0.5346622551502991;
  params.dotq_prev[0] = -0.5362376605895625;
  params.dotq_prev[1] = 0.2113782926017822;
  params.dotq_prev[2] = -1.2144776931994525;
  params.dotq_prev[3] = -1.2317108144255875;
  params.dotq_prev[4] = 0.9026784957312834;
  params.dotq_prev[5] = 1.1397468137245244;
}
