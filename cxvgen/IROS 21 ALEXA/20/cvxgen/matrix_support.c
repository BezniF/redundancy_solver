...
void multbymGT(double *lhs, double *rhs) {
  ...
  lhs[1] = 0;
  lhs[2] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[0]+(params.sigma[1]-params.sigma_0[1])*params.J[1]+(params.sigma[2]-params.sigma_0[2])*params.J[2]+(params.sigma[3]-params.sigma_0[3])*params.J[3]+(params.sigma[4]-params.sigma_0[4])*params.J[4]+(params.sigma[5]-params.sigma_0[5])*params.J[5]))-rhs[1]*(-params.Q_lim[0])-rhs[7]*(-1)-rhs[13]*(1)-rhs[19]*(-1)-rhs[25]*(1);
  lhs[3] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[6]+(params.sigma[1]-params.sigma_0[1])*params.J[7]+(params.sigma[2]-params.sigma_0[2])*params.J[8]+(params.sigma[3]-params.sigma_0[3])*params.J[9]+(params.sigma[4]-params.sigma_0[4])*params.J[10]+(params.sigma[5]-params.sigma_0[5])*params.J[11]))-rhs[2]*(-params.Q_lim[1])-rhs[8]*(-1)-rhs[14]*(1)-rhs[20]*(-1)-rhs[26]*(1);
  lhs[4] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[12]+(params.sigma[1]-params.sigma_0[1])*params.J[13]+(params.sigma[2]-params.sigma_0[2])*params.J[14]+(params.sigma[3]-params.sigma_0[3])*params.J[15]+(params.sigma[4]-params.sigma_0[4])*params.J[16]+(params.sigma[5]-params.sigma_0[5])*params.J[17]))-rhs[3]*(-params.Q_lim[2])-rhs[9]*(-1)-rhs[15]*(1)-rhs[21]*(-1)-rhs[27]*(1);
  lhs[5] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[18]+(params.sigma[1]-params.sigma_0[1])*params.J[19]+(params.sigma[2]-params.sigma_0[2])*params.J[20]+(params.sigma[3]-params.sigma_0[3])*params.J[21]+(params.sigma[4]-params.sigma_0[4])*params.J[22]+(params.sigma[5]-params.sigma_0[5])*params.J[23]))-rhs[4]*(-params.Q_lim[3])-rhs[10]*(-1)-rhs[16]*(1)-rhs[22]*(-1)-rhs[28]*(1);
  lhs[6] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[24]+(params.sigma[1]-params.sigma_0[1])*params.J[25]+(params.sigma[2]-params.sigma_0[2])*params.J[26]+(params.sigma[3]-params.sigma_0[3])*params.J[27]+(params.sigma[4]-params.sigma_0[4])*params.J[28]+(params.sigma[5]-params.sigma_0[5])*params.J[29]))-rhs[5]*(-params.Q_lim[4])-rhs[11]*(-1)-rhs[17]*(1)-rhs[23]*(-1)-rhs[29]*(1);
  lhs[7] = -rhs[0]*(((params.sigma[0]-params.sigma_0[0])*params.J[30]+(params.sigma[1]-params.sigma_0[1])*params.J[31]+(params.sigma[2]-params.sigma_0[2])*params.J[32]+(params.sigma[3]-params.sigma_0[3])*params.J[33]+(params.sigma[4]-params.sigma_0[4])*params.J[34]+(params.sigma[5]-params.sigma_0[5])*params.J[35]))-rhs[6]*(-params.Q_lim[5])-rhs[12]*(-1)-rhs[18]*(1)-rhs[24]*(-1)-rhs[30]*(1);
}
...
void fillh(void) {
  ...
  work.h[19] = -(-params.a_max[0]+params.dotq_prev[0]);
  work.h[20] = -(-params.a_max[1]+params.dotq_prev[1]);
  work.h[21] = -(-params.a_max[2]+params.dotq_prev[2]);
  work.h[22] = -(-params.a_max[3]+params.dotq_prev[3]);
  work.h[23] = -(-params.a_max[4]+params.dotq_prev[4]);
  work.h[24] = -(-params.a_max[5]+params.dotq_prev[5]);
  work.h[25] = -(-params.dotq_prev[0]-params.a_max[0]);
  work.h[26] = -(-params.dotq_prev[1]-params.a_max[1]);
  work.h[27] = -(-params.dotq_prev[2]-params.a_max[2]);
  work.h[28] = -(-params.dotq_prev[3]-params.a_max[3]);
  work.h[29] = -(-params.dotq_prev[4]-params.a_max[4]);
  work.h[30] = -(-params.dotq_prev[5]-params.a_max[5]);
}
void fillb(void) {
}
void pre_ops(void) {
