/* Produced by CVXGEN, 2021-01-26 06:17:54 -0500.  */
...
void load_default_data(void) {
  ...
  params.Q_lim[0] = 1.8864104246942706;
  params.Q_lim[1] = -1.077663182579704;
  params.Q_lim[2] = 0.7659100437893209;
  params.Q_lim[3] = 0.6019074328549583;
  params.Q_lim[4] = 0.8957565577499285;
  params.Q_lim[5] = -0.09964555746227477;
  params.h_lim[0] = 0.38665509840745127;
  params.h_lim[1] = -1.7321223042686946;
  params.h_lim[2] = -1.7097514487110663;
  params.h_lim[3] = -1.2040958948116867;
  params.h_lim[4] = -1.3925560119658358;
  params.h_lim[5] = -1.5995826216742213;
  params.sigma_obs[0] = -1.4828245415645833;
  params.sigma_obs[1] = 0.21311092723061398;
  params.sigma_obs[2] = -1.248740700304487;
  params.sigma_obs[3] = 1.808404972124833;
  params.sigma_obs[4] = 0.7264471152297065;
  params.sigma_obs[5] = 0.16407869343908477;
  params.h_safe[0] = 0.8287224032315907;
  params.A[0] = -0.9444533161899464;
  params.A[1] = 1.7069027370149112;
  params.A[2] = 1.3567722311998827;
  params.A[3] = 0.9052779937121489;
  params.A[4] = -0.07904017565835986;
  params.A[5] = 1.3684127435065871;
  params.B[0] = 0.979009293697437;
  params.dotq_min[0] = 0.6413036255984501;
  params.dotq_max[0] = 1.6559010680237511;
  params.a_max[0] = 0.5346622551502991;
  params.a_max[1] = -0.5362376605895625;
  params.a_max[2] = 0.2113782926017822;
  params.a_max[3] = -1.2144776931994525;
  params.a_max[4] = -1.2317108144255875;
  params.a_max[5] = 0.9026784957312834;
  params.dotq_prev[0] = 1.1397468137245244;
  params.dotq_prev[1] = 1.8883934547350631;
  params.dotq_prev[2] = 1.4038856681660068;
  params.dotq_prev[3] = 0.17437730638329096;
  params.dotq_prev[4] = -1.6408365219077408;
  params.dotq_prev[5] = -0.04450702153554875;
}
