...
void fillh(void) {
  ...
  work.h[2] = -params.dotq_min[1];
  work.h[3] = -params.dotq_min[2];
  work.h[4] = -params.dotq_min[3];
  work.h[5] = -params.dotq_min[4];
  work.h[6] = -params.dotq_min[5];
  work.h[7] = params.dotq_max[0];
  work.h[8] = params.dotq_max[1];
  work.h[9] = params.dotq_max[2];
  work.h[10] = params.dotq_max[3];
  work.h[11] = params.dotq_max[4];
  work.h[12] = params.dotq_max[5];
