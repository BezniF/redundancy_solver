...
void load_default_data(void) {
  ...
  params.A[0] = 1.3567722311998827;
  params.A[1] = 0.9052779937121489;
  params.A[2] = -0.07904017565835986;
  params.A[3] = 1.3684127435065871;
  params.A[4] = 0.979009293697437;
  params.A[5] = 0.6413036255984501;
  params.B[0] = 1.6559010680237511;
